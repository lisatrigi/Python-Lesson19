...
st.subheader("Top 15 authors by counts of books published from 2009-2022")
top_authors= filtered_books_df['Author'].value_counts().head(15)
top_authors.columns = ['Author', 'Count']
fig = px.bar(top_authors, x='Count', y='Author', orientation='h',
             title='Top 15 authors by counts of books published',
             labels={'Count':'Court of books published', 'Author':'Author'},
